...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const modalImage5 = document.getElementById("modalImage5");
    ...
    function populateModal(project) {
        ...
        modalImage4.src = project.imageUrl4;
        modalImage5.src = project.imageUrl5;
    }
    ...
    modalImage3.addEventListener("click", function(e) {
        showImageModal(e.target.src);
    });

    modalImage4.addEventListener("click", function(e) {
        showImageModal(e.target.src);
    });

    modalImage5.addEventListener("click", function(e) {
        showImageModal(e.target.src);
    });
